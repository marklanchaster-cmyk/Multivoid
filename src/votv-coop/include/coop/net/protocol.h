...
enum class ReliableKind : uint8_t {
    ...
    RepairOutcome = 130, // custom 65003: cooperative repair COMPLETION.
...
// custom 65003: a peer completed one of the previously-local repair minigames.
struct RepairOutcomePayload {
    WireKey key;          // save-stable key when available, deterministic actor name otherwise
